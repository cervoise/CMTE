...
result = open('spip3_plugins_list.txt', 'a+')
...
result.write("#Others modules from SPIP 2.0 SVN 19258\n")
result.write("filtres_images\n")
result.write("statistiques\n")
result.write("textwheel\n")
result.write("urls_etendues\n")
